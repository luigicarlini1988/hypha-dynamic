...
<head>
    ...
    <link rel="stylesheet" href="css/funnels.css">
    ...
    <script src="js/funnels.js" type="text/javascript"></script>
    ...
    <main id="target_funnel">
        ...
        <section id="target_header">
            ...
            <div id="target-header-foglio">
                ...
                <div class="immg">
                    <div class="hfb-wrap">
                        <img class="head-fun-back" src="img/funnels/funnels-back.png" />
                    </div>
                    <div class="hff-wrap">
                        <img class="head-fun-front" src="img/funnels/start-up.jpg" />
                    </div>
                </div>
            </div>
            ...
            <div class="foglio">
                ...
                <div class="test_monials">
                    <div class="tm">
                        <div class="up_tm">
                            <div class="tm_avatar">
                                <img src="img/funnels/user_x.jpg" />
                            </div>

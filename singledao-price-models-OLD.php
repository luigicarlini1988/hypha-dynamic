...
<head>
    ...
    <script src="js/single-price-model-OLD.js" type="text/javascript"></script>
        ...
        <section id="price-area">
            ...
            <div class="price-sidebar">
                ...
                <div class="ps-center">
                    ...
                    <p class="small">If you wish to <strong>build your own single DAO</strong> and let your organization
                        grow using Hypha’s tools, these are the price models for you! We provide 3 attractive price
                        plans with increasing feature inclusions, PLUS a <strong>free plan to help you try out the power
                            of our DAO solution!</strong> Click on the button below to select your preferred plan and
                        activate your DAO</p>
                    <div class="price-plan-ctas">
                        <a href="https://dao.hypha.earth/hypha/login?type=onboard" target="_blank"
                            class="button-dark-blu inact">Activate your DAO</a>
                    ...
                    <div class="models-list">
                        ...
                        <div id="ml-starter" class="model-card">
                            ...
                            <div class="card-section">
                                <div class="single_prices">
                                    <div class="big_top_price">
                                        <span class="dolo">$</span><span
                                            id="single_starter_price"></span><span>/mo</span>
                                    </div>
                                    <div class="year_price">
                        ...
                        <div id="ml-growth" class="model-card">
                            ...
                            <div class="card-section">
                                <div class="single_prices">
                                    <div class="big_top_price">
                                        <span class="dolo">$</span><span
                                            id="single_growth_price"></span><span>/mo</span>
                                    </div>
                                    <div class="year_price">
                        ...
                        <div id="ml-thrive" class="model-card">
                            ...
                            <div class="card-section">
                                <div class="single_prices">
                                    <div class="big_top_price">
                                        <span class="dolo">$</span><span
                                            id="single_thrive_price"></span><span>/mo</span>
                                    </div>
                                    <div class="year_price">
                    ...
                    <div id="opt_list" class="models-list">
                        ...
                        <div class="model-card">
                            ...
                            <div class="card-section second">
                                <p>1:1 Workshop<span> Activation</span><span class="priz"><span
                                            class="dolo">$</span><span id="work-free"></span></span></p>
                            </div>
                        </div>
                        ...
                        <div class="model-card">
                            ...
                            <div class="card-section second">
                                <p>1:1 Workshop<span> Activation</span><span class="priz"><span
                                            class="dolo">$</span><span id="work-start"></span></span></p>
                            </div>
                        </div>
                        ...
                        <div class="model-card">
                            ...
                            <div class="card-section second">
                                <p>1:1 Workshops<span> Activation</span><span class="priz"><span
                                            class="dolo">$</span><span id="work-grow"></span></span></p>
                            </div>
                        </div>
                        ...
                        <div class="model-card">
                            ...
                            <div class="card-section second">
                                <p>1:1 Workshops<span> Activation</span><span class="priz"><span
                                            class="dolo">$</span><span id="work-thrive"></span></span></p>

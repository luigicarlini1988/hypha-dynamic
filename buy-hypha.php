...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/buy-hypha.css">
    ...
    <script src="js/buy-hypha.js" type="text/javascript"></script>
                                                    ...
                                                    <div class="combo-box" id="crypto-select">
                                                        <div class="box-inner">
                                                            <div class="combo-item">
                                                                <img src="img/buy-hypha-tokens/eos.png" alt="EOS">
                                                                <span data-currency="eos" class="selected-item">EOS</span><span class="currency-fees">(Preferred)</span>
                                                            </div>
                                                        </div>
                                                        <div class="box-chevron">
                                                            <i class="material-icons"><img src="img/buy-hypha-tokens/arrow-down-dark.svg" alt="Click to Open"></i>
                                                        </div>
                                                            ...
                                                            <div class="dropdown-inner has-slimscroll">
                                                                <ul>
                                                                  ...
                                                                  <li class="is-active">
                                                                    ...
                                                                    <li>
                                                                        <span class="item-icon">
                                                                                <img src="img/buy-hypha-tokens/usd.png" alt="Debit/Credit Card">
                                                                            </span>
                                                                    ...
                                                                    <li>
                                                                        <span class="item-icon">
                                                                                <img src="img/buy-hypha-tokens/usd.png" alt="Peer to Peer Swap">
                                                                            </span>
                                                                    ...
                                                                    <li>
                                                                        <span class="item-icon">
                                                                                <img src="img/buy-hypha-tokens/btc.png" alt="BTC - Bitcoin">
                                                                            </span>
                                                                    ...
                                                                    <li>
                                                                        <span class="item-icon">
                                                                                <img src="img/buy-hypha-tokens/tlos.png" alt="TLOS - Telos">
                                                                            </span>
                                                                    ...
                                                                    <li class="is-disabled">
                                                                        <span class="item-icon">
                                                                                <img src="img/buy-hypha-tokens/eth.png" alt="ETH - Ethereum">
                                                                            </span>
                                        ...
                                        <div class="field-wrapper">
                                            ...
                                            <div class="field">
                                                <div class="control has-icons-left has-icons-right currency-field crypto-field">
                                                    ...
                                                    <span class="crypt is-left">
                                                        <img src="img/buy-hypha-tokens/seeds.png" alt="Seeds">
                                                    </span>
                                            ...
                                            <div class="field">
                                                <div class="control has-icons-left has-icons-right currency-field fiat-field">
                                                    ...
                                                    <span class="crypt is-left">
                                                        <img src="img/buy-hypha-tokens/usd.png" alt="USD">
                                                    </span>
                                                    <span class="crypt is-right">
                                                        USD
                                                    </span>
